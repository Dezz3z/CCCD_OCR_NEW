...
class StubRecognizer:
    ...
    def __init__(self, text: str | None, *, explode: bool = False) -> None:
        self._text = text
    ...
    def recognize_region(self, image, bbox, charset_hint):
        ...
        return None if self._text is None else TextRegion(bbox, self._text, 0.9)
...
class TestBandSelection:
    def test_reads_from_the_binarized_mrz_variant(self):
        _, _, image_set = read_with("\n".join(REAL_MRZ_LINES))
        assert "v4" in image_set.accessed
